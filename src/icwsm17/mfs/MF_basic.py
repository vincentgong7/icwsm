...
class MF_basic(object):
    ...
    def call_membership_fun_basic(self, cell_id, record_start_ts, record_end_ts):
...
#         db_conn_str = "dbname='{0}' user='{1}' host='{2}' password='{3}' port='{4}'".format('icwsm17','postgres','localhost','postgres','5432')
        ...
        for i in range(0, round((record_end_ts - record_start_ts) / self.bin_ts)):
            ...
            cell_coord_list = cp.cell_points_list[cell_id]
...
#     outputfolder = '/root/case2/socialmedia/result/0531-v1'
    ...
    # cell_id = 1 # 0-3 = cell 1-4
        ...
        output_file = '{}/mf_basic/mf_{}_cell_{}.txt'.format(outputfolder, strategy_suffix, cell_id)

        # cell_id, record_start_ts, record_end_ts
        result = mf_strategy.call_membership_fun_basic(cell_id, record_start_ts, record_end_ts)
