...
# sum-up result   
            ...
            all_total_density = all_total/ self.ep.cell_area[cell_id]
#             print(all_total)
            ...
            all_total_density_list.append(all_total_density)
...
#         sm_cell_flow_list = [np.asarray(all_sequence_list), np.asarray(all_before_list), np.asarray(all_after_list), np.asarray(all_base_list), np.asarray(all_total_list)]
        sm_cell_flow_list = [np.asarray(all_before_list), np.asarray(all_after_list), np.asarray(all_base_list), np.asarray(all_total_list), np.asarray(all_total_density_list)]
...
def main():
    ...
    port = 9634
    outputfolder = '/Users/vgong/Desktop/icwsm/kings2016/case2/data/sm_data/processed/0922-v1/mf_prob'
...
#     outputfolder = '/root/case2/socialmedia/result/0531-v1'
    ...
    #         record_end_ts = tb.date2ts('2016-04-28 23:00:00')
            ...
            output_file = '{}/mf_{}_cell_{}{}_gap_{}.txt'.format(outputfolder, strategy_suffix, cell_id, extra_out_put_flag, delta_tm)
