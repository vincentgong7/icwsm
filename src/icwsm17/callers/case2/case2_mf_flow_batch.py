...
def main():
    ...
    mf_prob_folder = "{}/{}/mf_speed_all_deltaT".format(folder,case)
    mf_flow_folder = "{}/{}/mf_flow_all_deltaT".format(folder,case)
    ...
    result.to_csv("{}/mf_flow_per_hour_deltaT_all.txt".format(mf_flow_folder))
    print("Done.------------------------------------------------------")
