...
def main():
    ...
    dic["ep"] = ep
    dic["mf.rate.twitter_table"] = 'case2smd.v_twitter_geo_is'
    dic["mf.rate.inst_table"] = 'case2smd.v_inst_geo_is'
    
    result_df = c2ba.process(dic)
    output_file = '{}/case_2_mf_flow_before_after.txt'.format(dic["outputfolder"])
