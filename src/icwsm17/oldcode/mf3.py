...
#         mf2p5v2_mf_np_users_direction(platform, timeing, direction,cell_id, start_ts, end_ts, prior_ts, extra_ts, max_length, norm_dis_scale)
        ...
        twitter_before = mf3v2_mf_np_users_direction('twitter', 'before','radiation',cell_id, start_ts, end_ts, prior_ts, extra_ts, max_length, max_length/3)
        twitter_after = mf3v2_mf_np_users_direction('twitter','before', 'radiation',cell_id,start_ts, end_ts, prior_ts, extra_ts, max_length, max_length/3)
        
        inst_before = mf3v2_mf_np_users_direction('inst','after','radiation',cell_id, start_ts, end_ts, prior_ts, extra_ts, max_length, max_length/3)
        inst_after = mf3v2_mf_np_users_direction('inst','after','radiation',cell_id, start_ts, end_ts, prior_ts, extra_ts, max_length, max_length/3)
