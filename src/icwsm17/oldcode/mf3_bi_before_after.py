...
#         direction: left, right, bidirection, radiation 
        ...
        twitter_after = mf3v2_mf_np_users_direction('twitter','after','bidirection',cell_id,start_ts,end_ts,prior_ts,extra_ts,max_length,max_length/3)       
        inst_before = mf3v2_mf_np_users_direction('inst','before','bidirection',cell_id,start_ts,end_ts,prior_ts,extra_ts,max_length,max_length/3)
...
sm_flow_list = []
run = 'mf5'
output_file = './mf_bi_before_after.data'
for cell_id in range(0,4):    
