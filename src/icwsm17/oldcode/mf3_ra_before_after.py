...
#         direction: left, right, bidirection, radiation 
        ...
        twitter_after = mf3v2_mf_np_users_direction('twitter','after','radiation',cell_id,start_ts,end_ts,prior_ts,extra_ts,max_length,max_length/3)       
        inst_before = mf3v2_mf_np_users_direction('inst','before','radiation',cell_id,start_ts,end_ts,prior_ts,extra_ts,max_length,max_length/3)
...
#         twitter_before_redundant = membership_fun1_twitter(cell_points_list[cell_id],start_ts-prior_ts,start_ts)[0]
#         twitter_after_redundant = membership_fun1_twitter(cell_points_list[cell_id],end_ts,end_ts + extra_ts)[0]
...
#         based on mf2 --- start
        ...
        twitter_before_redundant = membership_fun2_twitter(cell_id, 112, start_ts-prior_ts,start_ts)
        twitter_after_redundant =  membership_fun2_twitter(cell_id, 112, end_ts,end_ts + extra_ts)
...
sm_flow_list = []
run = 'mf5'
output_file = './mf3_ra_before_after.data'
for cell_id in range(0,4):    
